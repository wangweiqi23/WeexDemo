...
public class PullRefreshLayout extends ViewGroup {
    ...
    private static final int DRAG_MAX_DISTANCE = 78;
...
//    private int[] mColorSchemeColors;
    ...
    private ImageView mFrameAnimView;
...
//        setRefreshStyle(type);
        ...
        mRefreshView.setLayerType(LAYER_TYPE_HARDWARE, null);
        addView(mRefreshView, 0);

        mFrameAnimView = new ImageView(context);
        mFrameAnimView.setBackgroundResource(R.drawable.lion_anim);
        mFrameAnimDrawable = (AnimationDrawable) mFrameAnimView.getBackground();
        mFrameAnimView.setVisibility(View.GONE);

        addView(mFrameAnimView, 1);
    ...
    public void setRefreshDrawable(RefreshDrawable drawable) {
        ...
        mRefreshDrawable.setHeight(dp2px(DRAG_MAX_DISTANCE));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mFrameAnimView.measure(DensityUtil.dip2px(318), DensityUtil.dip2px(148));
    ...
    private void ensureTarget() {
        ...
        if (getChildCount() > 0) {
            for (int i = 0; i < getChildCount(); i++) {
                ...
                if (child != mRefreshView && child != mFrameAnimView)
                    mTarget = child;
            }
        }
    }
        ...
        public void onAnimationEnd(Animation animation) {
            if (mRefreshing) {
                ...
                postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        mFrameAnimView.setVisibility(VISIBLE);
                ...
                mFrameAnimView.setVisibility(GONE);
                mRefreshView.setVisibility(View.GONE);
                animateOffsetToStartPosition();
            }
...
//        mRefreshView.bringToFront();
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int frameAnimLeft = (left + width - right - DensityUtil.dip2px(200)) / 2;
        int frameAnimRight = frameAnimLeft + DensityUtil.dip2px(200);

        mFrameAnimView.layout(frameAnimLeft, top,
                frameAnimRight, DensityUtil.dip2px(93));
    }
