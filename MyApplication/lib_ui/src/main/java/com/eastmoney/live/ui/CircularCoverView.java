...
public class CircularCoverView extends View {
    ...
    private Bitmap drawSector(int w, int h) {
        mSectorBitmap = Bitmap.createBitmap(w, h, Bitmap.Config.ARGB_8888);
        Canvas c = new Canvas(mSectorBitmap);
    ...
    private Bitmap drawRect(int w, int h) {
        ...
        Canvas c = new Canvas(mRectBitmap);
        Paint p = new Paint(Paint.ANTI_ALIAS_FLAG);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mRectBitmap = drawRect(w, h);
        mSectorBitmap = drawSector(w, h);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawBitmap(mSectorBitmap, 0, 0, mPaint);
