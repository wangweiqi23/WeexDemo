...
public class WXSDKEngine {
  ...
  public static void init(Application application, IWXUserTrackAdapter utAdapter) {
    ...
    /**
     * Deprecated. Use {@link #initialize(boolean debug, Application, InitConfig)} instead.
     */
    @Deprecated
    public static void init(Application application, IWXUserTrackAdapter utAdapter, String
            framework) {
        initialize(false, application,
     ...
     */
    public static void initialize(boolean debug, Application application, InitConfig config) {
        synchronized (mLock) {
            if (mIsInit) {
                return;
            }
            ...
            doInitInternal(debug, application, config);
    ...
    private static void doInitInternal(boolean debug, final Application application, final
    InitConfig config) {
        WXEnvironment.setIsApkDebug(debug);
    ...
    @Deprecated
    public static void init(Application application, String framework, IWXUserTrackAdapter
            utAdapter, IWXImgLoaderAdapter imgLoaderAdapter, IWXHttpAdapter httpAdapter) {
        initialize(false, application,
                new InitConfig.Builder()
                        .setUtAdapter(utAdapter)
