...
public class WXSlider extends WXVContainer<FrameLayout> {
  ...
  protected FrameLayout initComponentHostView(@NonNull Context context) {
    ...
    if (this.getDomObject() != null && this.getDomObject().getAttrs() != null) {
      isNeedLoop = this.getDomObject().getAttrs().needLoop();
    }
    mAdapter = new WXCirclePageAdapter(isNeedLoop);
  ...
  protected boolean setProperty(String key, Object param) {
    switch (key) {
      ...
      case Constants.Name.TYPE:
        boolean type = WXUtils.getBoolean(param, true);
        setType(type);
        return true;
  ...
  public void setType(boolean enabled) {
  }
