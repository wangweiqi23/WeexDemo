...
public class WXLoadingLayout extends WXBaseRefreshLayout {
    ...
    protected void initView(Context context) {
        ...
        View linearLayout = layoutInflater.inflate(R.layout.item_load, this, false);
        mTextView = (TextView) linearLayout.findViewById(R.id.tv_loading);
        mProgressBar = (ProgressBar) linearLayout.findViewById(R.id.progress_bar);
    ...
    public void showError() {
        mTextView.setText(getResources().getString(R.string.load_error));
        mProgressBar.setVisibility(View.GONE);
        setVisibility(View.VISIBLE);
    }
