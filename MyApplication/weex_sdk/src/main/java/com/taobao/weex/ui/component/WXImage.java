...
public class WXImage extends WXComponent<ImageView> {
    ...
    @Deprecated
    public WXImage(WXSDKInstance instance, WXDomObject dom, WXVContainer parent, String
    ...
    private void setRemoteSrc(Uri rewrited) {
        ...
        imageStrategy.blurRadius = (int)getDomObject().getStyles().getBorderRadius();
        ...
        imageStrategy.setImageListener(new WXImageStrategy.ImageListener() {
            ...
            public void onImageFinish(String url, ImageView imageView, boolean result, Map extra) {
                if (getDomObject() != null && getDomObject().getEvents().contains(Constants.Event
                    ...
                    if (imageView != null && imageView.getDrawable() != null && imageView
                            .getDrawable() instanceof ImageDrawable) {
                        size.put("naturalWidth", ((ImageDrawable) imageView.getDrawable())
                                .getBitmapWidth());
                        size.put("naturalHeight", ((ImageDrawable) imageView.getDrawable())
                                .getBitmapHeight());
                    } else {
